...
\begin{UCtrayectoria}{Principal}
	...
	\UCpaso Verifica los datos proporcionados por el usuario con base en las reglas de negocios \BRref{RN1}{Datos requeridos},  \BRref{RN2}{Datos correctos}, \BRref{RN3}{Unicidad de elementos} .  \Trayref{A}  \Trayref{B}  \Trayref{C}  
...
\begin{UCtrayectoriaA}{A}{Datos incorrectos}
	...
	\UCpaso[\UCactor] Continua en el paso \ref{CUCL7Regresa} del \UCref{CUCL7}
