...
\begin{UseCase}{CUCL1}{Subir archivo}{El usuario seleccionara el archivo que desea que sea almacenado en la nube, este archivo será cifrado y enviado de manera transparente para el usuario, y dependiendo si el archivo se detecta duplicado se enviaran distintos archivos.}
...
\begin{UCtrayectoriaA}{C}{Número aleatorio incorrecto}
	...
	\UCpaso Continua en el paso \ref{CUCL2Regreso} del \UCref{CUCL2}.
\end{UCtrayectoriaA}
...
\begin{UCtrayectoriaA}{E}{Archivo duplicado}
	...
	\UCpaso Continua en el paso \ref{CUCL2Regreso2} del \UCref{CUCL2}.
\end{UCtrayectoriaA}
