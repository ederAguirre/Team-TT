...
\hline \hline
RF – SLL1 & El sistema permitirá la generación de llaves de usuario a través de una clave secreta (Ks) propia del servidor de llaves. \\ \hline
...
RF – SLL2 & El sistema almacenará en la base de datos del servidor de llaves, la firma a ciegas (y) generada por cada nuevo archivo que se solicite cargar al servicio de almacenamiento. \\ \hline
...
RF – CL19 & El sistema cifrará la llave (K) junto con el archivo (F) que el usuario a solicitado, y generara el cifrado C1.\\ \hline
...
RF – CL20 & El sistema cifrará  la llave secreta (Ka) junto con la llave (K) que el usuario a solicitado, y generará el cifrado C2 \\ \hline
...
RF – CL21 & El sistema descifrará el C1 junto con la llave secreta (Ka) que el usuario a solicitado descargar y generará la llave (K) del archivo (F).\\ \hline
