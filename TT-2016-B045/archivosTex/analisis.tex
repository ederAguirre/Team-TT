...
\hline
\multicolumn{2}{|c|}{\textbf{Sistemas operativos}} \\ \hline
\textbf{Tipo} &  \textbf{Cantidad} \\
\hline \hline
Windows 8.1 Pro & 2\\ \hline
Windows 10 Pro & 1\\ \hline
...
\\ El servidor que nos proveerá del almacenamiento en la nube de nombre \textbf{ownCloud.org} es de libre acceso y no existe restricción alguna la utilización de este. Nos permite una libre manipulación y configuración de tal modo que podamos cumplir nuestros objetivos.
