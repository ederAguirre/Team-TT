...
siglas en ingl\'es) y DES (Data Encryption Standard, por sus siglas en ingl\'es). \\ \\ Los cifradores por bloques pueden ser representados mediante el siguiente diagrama. ~\ref{fig:2-2-2}.

\begin{figure}[H]
\centering
	\includegraphics[width=10cm, height=5cm]{./images/CifradoBloques.jpg}
