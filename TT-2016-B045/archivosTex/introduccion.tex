...
\hline
{Gratuita o de paga}  & {Sin información} & {Ambos} & {Sin infromación  }  & {Gratuito} & {Sin información} \\
\hline
\end{tabular}
...
Es un servicio que promete almacenamiento seguro, integridad y confidencialidad a largo plazo y va enfocado a aplicaciones backup.
\item SIGOPS Oper.Syst.\\
